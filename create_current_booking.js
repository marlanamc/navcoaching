...
async function createCurrentBooking() {
  const bookingId = '84kpeRdpYyjtTyfyv9c8QW'
  ...
  const bookingData = {
    ...
    user_email: 'mmcreed3@gmail.com',
    user_name: 'Marlie Creed',
    start_time: '2025-08-14T13:45:00.000Z',
    end_time: '2025-08-14T14:15:00.000Z',
  ...
  if (createError) {
    ...
    console.log('Payment URL: http://localhost:3002/booking/pay?id=' + bookingId)
  }
}
