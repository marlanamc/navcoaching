    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-navy mb-8 text-center font-playfair">
          What You <span className="text-ocean">Get</span>
        </h2>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Primary: Weekly Coaching */}
          <div className="lg:col-span-3 bg-white/90 p-8 rounded-2xl shadow-soft content-card border border-white/40">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full bg-freshaqua text-navy">Core Offer</div>
              <div className="w-16 h-16 bg-softblue rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
              </div>
            </div>
            <h3 className="text-2xl font-bold text-navy mb-4 text-center">Weekly Coaching</h3>
            <ul className="space-y-2 max-w-2xl mx-auto text-navy">
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>One 60‑min deep dive per month</span></li>
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Weekly 30‑min video check‑ins</span></li>
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Weekly experiments to help you stay on track</span></li>
            </ul>
            <div className="mt-5 flex items-center justify-center gap-3">
              <Link href="/services#pricing" className="text-ocean font-semibold hover:text-coral transition">Learn more</Link>
              <span className="text-gray-300">•</span>
              <a href="https://calendly.com/marlie-navcoaching/initial" target="_blank" rel="noopener noreferrer" className="text-navy underline hover:text-tealblue">Book a consult</a>
            </div>
          </div>

          {/* Secondary: Private Dashboard */}
          <div className="bg-white/90 p-6 rounded-2xl shadow-soft content-card border border-white/40">
            <div className="flex justify-center mb-3">
              <div className="w-14 h-14 bg-softblue rounded-full flex items-center justify-center">
            ...
            <ul className="space-y-2 text-navy">
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Brainstorming space</span></li>
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Session notes</span></li>
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Progress tracking</span></li>
            </ul>
          </div>
          ...
          <div className="bg-white/90 p-6 rounded-2xl shadow-soft content-card border border-white/40">
            ...
            <ul className="space-y-2 text-navy">
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Join virtual coworking sessions</span></li>
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Camera on optional!</span></li>
              <li className="flex items-start"><span className="text-tealblue mr-2">•</span><span>Work alongside others with ADHD</span></li>
            </ul>
          </div>
        </div>
      </section>
