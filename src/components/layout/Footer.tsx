      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-freshaqua hover:text-white transition" aria-label="Instagram">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-freshaqua">Quick Links</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/" className="text-gray-300 hover:text-freshaqua transition">Home</Link>
              </li>
              <li>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-freshaqua">Contact</h3>
        ...
        <div className="border-t border-gray-800 pt-6 mb-6">
          <div className="bg-gray-900 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-gray-400 mb-2">Important Notice</h4>
            <p className="text-xs text-gray-400 leading-relaxed mb-3">
              Navigating the Storm provides accountability coaching services to help you accomplish your goals. Our services fill the gap between therapy and medication, offering structured support for ADHD challenges.
            </p>
            <p className="text-xs text-gray-400 leading-relaxed mb-3">
              These services are not therapy, medical treatment, or a substitute for professional healthcare. If you're experiencing mental health concerns, please consult with qualified healthcare providers.
            </p>
            <div className="flex flex-wrap gap-4 text-xs">
              <Link 
                href="/terms" 
                className="text-freshaqua hover:text-white transition inline-flex items-center"
              >
